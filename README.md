...
| **Έκδοση** | v0.9.5 beta — Απρίλιος 2026 |
...
Κλικ **📋 Εκπ/κοί ανά Ειδικότητα** στο κύριο παράθυρο για εξαγωγή λίστας εκπαιδευτικών συγκεκριμένης ειδικότητας:
...
- Αποτελέσματα ταξινομημένα αλφαβητικά στον φάκελο `Έγγραφα → MySchoolChecks → results_YYYYMMDD`

**Απαιτούμενα αρχεία:** Τοποθετήσεις + Κατάλογος σχολείων (2.1) + stat4_1 + stat4_2 + stat4_16

---

## Στοιχεία Σχολικών Μονάδων

Κλικ **🏫 Σχολικές Μονάδες** στο κύριο παράθυρο για εξαγωγή στοιχείων Δημοτικών Σχολείων και Νηπιαγωγείων ανά Δήμο:

- Επίλεξε **Δήμο** από το dropdown
- Επίλεξε **Ανά Σχολική Μονάδα** ή **Ανά Τάξη**
  - *Ανά Μονάδα:* σύνολα μαθητών ανά σχολείο + Τηλέφωνο, e-mail, Διεύθυνση, Ονομ/μο & στοιχεία Διευθυντή
  - *Ανά Τάξη:* αναλυτική κατανομή ανά τάξη (Αγόρια/Κορίτσια) + στοιχεία επικοινωνίας — μερικά αθροίσματα μόνο για Δημοτικά
...
**Απαιτούμενα αρχεία:** 2.2 (Εκτεταμένα Στοιχεία) + 3.1 (Κατανομή μαθητών)
